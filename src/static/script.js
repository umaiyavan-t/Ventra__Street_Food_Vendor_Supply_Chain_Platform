document.addEventListener("DOMContentLoaded", () => {
  ...
  const products = [
    {
      ...
      price: 500,
      image:
        "https://media.istockphoto.com/id/1126345377/photo/rice-in-a-wooden-bowl.jpg?s=2048x2048&w=is&k=20&c=BN7TuJwGcrqyMJVMcl3MMM9WCldSxAiAMM1CV5TqyzI=",
      category: "grains",
      sellerId: 1,
    },
    {
      ...
      price: 50,
      image:
        "https://dnmart.in/wp-content/uploads/2023/10/6c0922112248c9820fc01f592ce6e4eb.jpg",
      category: "veggies",
      sellerId: 2,
    },
    {
      ...
      price: 120,
      image:
        "https://info.ehl.edu/hubfs/EHL-Passugg_Blog_Kurkuma_Titelbild_001.jpg",
      category: "masala",
      sellerId: 3,
    },
    {
      ...
      price: 80,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqIeheeud63ZffYao2xVLf_e_q0-6A0e08nA&s",
      category: "spices",
      sellerId: 4,
    },
    {
      ...
      price: 180,
      image:
        "https://dirtanddough.com/wp-content/uploads/2023/07/overnight-sourdough-bread-0108.jpg",
      category: "bakery",
      sellerId: 5,
    },
    {
    ...
    },
    {
      ...
      price: 350,
      image:
        "https://urbandelight.in/cdn/shop/files/2_fb492171-ce87-4bb9-beb6-7f6e781084d0.jpg?v=1745755636&width=1445",
      category: "grains",
      sellerId: 2,
    },
    {
      ...
      price: 90,
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwNh-nfEbP1YnvVaFy5MHi-FdJHz7Q_tMFCA&s",
      category: "masala",
      sellerId: 3,
    },
    {
      ...
      price: 70,
      image:
        "https://silvaintl.imgix.net/blog/Bell-Peppers-Flavorful.jpg?auto=compress%2Cformat&ch=dpr&cs=srgb&dpr=1&fit=crop&fp-x=0.5&fp-y=0.5&h=375&ixlib=php-3.1.0&q=75&sharp=10&step=100&w=375",
      category: "veggies",
      sellerId: 4,
    },
    {
      ...
      price: 60,
      image:
        "https://m.media-amazon.com/images/I/61n+pSpab9L._UF1000,1000_QL80_.jpg",
      category: "spices",
      sellerId: 5,
    },
  ];
  ...
  const sellers = [
    ...
    },
    {
      ...
      score: 810,
      avatar:
        "https://images.pexels.com/photos/712521/pexels-photo-712521.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
    },
    {
      id: 5,
  ...
  const sellerDetailedProfiles = {
    1: {
      ...
      addresses: [
        {
          street: "Plot No. 1, Okhla Ind. Area",
          city: "Delhi",
          state: "Delhi",
          pincode: "110020",
          label: "Main Depot",
      ...
      reviews: [
        {
          rating: 4.8,
          reviewer: "Food Corner",
          comment:
            "Excellent rice quality and quick dispatch. Highly recommended for bulk purchases.",
        },
        {
          rating: 4.5,
          reviewer: "Local Dhaba",
          comment:
            "Consistent supply, prices are competitive. Sometimes delivery is a bit slow during peak hours.",
        },
      ],
      stats: {
        products: 85,
      ...
      weeklyInsights: [
        {
          ...
          value: "150 this week",
          dotColor: "primary-yellow",
        },
        {
          label: "Products Sold",
          value: "2500 units total",
          dotColor: "secondary-red",
        },
        {
    ...
    2: {
      ...
      addresses: [
        {
          street: "Farm Road 5, Sector 135",
          city: "Noida",
          state: "Uttar Pradesh",
          pincode: "201304",
          label: "Farmhouse & Dispatch",
          isDefault: true,
        },
      ],
      reachablePlaces: [
      ...
      reviews: [
        {
          rating: 4.9,
          reviewer: "Chef's Kitchen",
          comment:
            "The freshest vegetables we've ever received. Fantastic quality and vibrant produce!",
        },
        {
          rating: 4.7,
          reviewer: "Local Vendor",
          comment:
            "Reliable source for organic veggies. Prices are fair, and their greens are exceptional.",
        },
      ],
      stats: {
        products: 45,
    ...
    3: {
      ...
      addresses: [
        {
          street: "Unit 15, Spices Hub, Sector 34",
          city: "Gurgaon",
          state: "Haryana",
          pincode: "122001",
      ...
      reachablePlaces: ["Gurgaon, Delhi NCR", "Pan-India (bulk orders)"],
      reviews: [
        {
          rating: 5.0,
          reviewer: "Biryani House",
          comment:
            "Their garam masala is simply divine! Always enhances the flavor.",
        },
        {
          rating: 4.8,
          reviewer: "Mom's Kitchen",
          comment:
            "Finest quality spices, fresh and potent. Packaging is excellent too.",
        },
      ],
      stats: {
        products: 200,
    ...
    4: {
      ...
      reachablePlaces: ["Faridabad, Palwal, Gurgaon (select areas)"],
      reviews: [
        {
          rating: 4.5,
          reviewer: "Fruit Cart",
          comment:
            "Their seasonal fruits are always a hit with my customers. Good quality!",
        },
        {
          rating: 4.2,
          reviewer: "Juice Stand",
          comment:
            "Sometimes delivery is delayed, but produce quality is generally good.",
        },
      ],
      stats: {
        products: 60,
      ...
      weeklyInsights: [
        ...
        {
          label: "Repeat Customers",
          value: "35 buyers returned",
          dotColor: "secondary-red",
        },
        {
          label: "Top Product",
          value: "Mangoes (seasonal)",
          dotColor: "primary-yellow",
        },
      ],
    },
    5: {
      ...
      reachablePlaces: ["Ghaziabad, East Delhi", "Limited Noida areas"],
      reviews: [
        {
          rating: 4.7,
          reviewer: "Street Bakery",
          comment:
            "Fresh bread daily, my customers love it. Never faced any issues.",
        },
        {
          rating: 4.0,
          reviewer: "Cafe Corner",
          comment:
            "Good quality, but their delivery slot is a bit early for our needs.",
        },
      ],
      stats: {
        products: 25,
  ...
  function showAlert(message, type = "error") {
    ...
    alertDiv.innerHTML = `<span class="material-icons">${
  ...
  function renderProducts(filterCategory = "all", searchTerm = "") {
    ...
    if (filteredProducts.length === 0) {
      productGrid.innerHTML =
        '<p style="text-align: center; width: 100%; color: #777; font-size: 1.1em; padding: 20px;">No products found matching your criteria.</p>';
      return;
    }
  ...
  if (searchInput) {
    searchInput.addEventListener("input", () => {
      const currentCategory = document.querySelector(".category-button.active")
        .dataset.category;
  ...
  if (marketValueToggle) {
    ...
    if (window.innerWidth >= 769) {
      marketValueToggle.querySelector(".material-icons").style.transform =
        "rotate(0deg)";
    }
  ...
  function renderCheckoutSummary() {
    ...
    if (cart.length === 0) {
      ...
      if (checkoutForm)
        checkoutForm.querySelector(".place-order-button").disabled = true;
      return;
    }
    ...
    cart.forEach((item) => {
      ...
      orderItemDiv.innerHTML = `
                <span class="item-name-qty">${item.name} (x${
        item.quantity
      })</span>
    ...
    subtotalDiv.innerHTML = `<span>Subtotal:</span><span>₹${subtotal.toFixed(
      2
    )}</span>`;
    ...
    deliveryFeeDiv.innerHTML = `<span>Delivery Fee:</span><span class="item-price-total">₹${deliveryFee.toFixed(
      2
    )}</span>`;
    ...
    if (checkoutForm)
      checkoutForm.querySelector(".place-order-button").disabled = false;
  }
  ...
  const trackingStatusContainer = document.getElementById(
  ...
  function renderTrackingDetails() {
    ...
    trackingInfoDiv.innerHTML = `
            ...
            <p><strong>Status:</strong> <span id="current-order-status">${
              order.status
            }</span></p>
  ...
  function renderBuyerProfile() {
    ...
    const AlexJohnData = {
      ...
      avatar:
        "https://images.pexels.com/photos/1036627/pexels-photo-1036627.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2", // Example Pexels image for Alex John
      balance: 202500,
      addresses: [
        {
          street: "123, Industrial Area, Peenya",
          city: "Bangalore",
          state: "Karnataka",
          pincode: "560058",
        ...
        {
          street: "45, Market Road, Yeshwanthpur",
          city: "Bangalore",
          state: "Karnataka",
          pincode: "560022",
          label: "Secondary Godown",
          isDefault: false,
        },
      ],
      stats: {
    ...
    if (profileLocation)
      profileLocation.textContent = currentUserData.location || "N/A";
    if (profileRole) profileRole.textContent = currentUserData.role || "N/A";
    if (profileDescription)
      profileDescription.textContent = currentUserData.description || "";
    if (profileAvatar)
      profileAvatar.src =
        currentUserData.avatar ||
        "https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"; // Default avatar
    if (walletBalance)
      walletBalance.textContent = `₹${
        currentUserData.balance
          ? currentUserData.balance.toLocaleString("en-IN")
          : "0"
      }`;
      ...
      currentUserData.addresses.forEach((address) => {
        ...
        addressDiv.innerHTML = `
          ...
          address.pincode
                    ...
                    <p class="address-label">${address.label} ${
          address.isDefault
            ? '<span class="default-address-tag">Default Address</span>'
            : ""
        }</p>
                `;
    ...
    if (statDelivered)
      statDelivered.textContent = currentUserData.stats.delivered;
    if (statCancelled)
      statCancelled.textContent = currentUserData.stats.cancelled;
    if (statRating) statRating.textContent = currentUserData.stats.rating;
    if (statLifetimeSpent)
      statLifetimeSpent.textContent = `${currentUserData.stats.lifetimeSpent}+`;
      ...
      currentUserData.transactions.forEach((transaction, index) => {
        ...
        switch (transaction.status) {
          case "Delivered":
            ...
            iconifyIcon = "mdi:truck-check";
            break;
          case "Pending":
            statusClass = "status-pending";
            iconifyIcon = "mdi:clock-outline";
            break;
          case "Cancelled":
            statusClass = "status-cancelled";
            iconifyIcon = "mdi:cancel";
            break;
          case "Out for Delivery":
            statusClass = "status-out-for-delivery";
            iconifyIcon = "mdi:truck-delivery";
            break;
        }
        transactionDiv.innerHTML = `
                    <div class="transaction-details">
                        <span class="transaction-name">${index + 1}. ${
          transaction.item
        }</span>
                        <span class="transaction-status ${statusClass}"><iconify-icon icon="${iconifyIcon}"></iconify-icon> ${
          transaction.status
        }</span>
                    </div>
                    <span class="transaction-price">₹${transaction.price.toLocaleString(
                      "en-IN"
                    )}</span>
                `;
    ...
    if (categoriesList) {
      ...
      currentUserData.categoriesOrdered.forEach((category) => {
        ...
        categoryLi.innerHTML = `
                    <span class="category-name"><iconify-icon icon="${
                      categoryIcons[category.name] || "mdi:food"
                    }"></iconify-icon> ${category.name}</span>
    ...
    if (paymentLogsList) {
      ...
      currentUserData.paymentLogs.forEach((log) => {
        ...
        paymentLi.innerHTML = `
                    ...
                    <span class="payment-amount">₹${log.amount.toLocaleString(
                      "en-IN"
                    )}</span>
                `;
  ...
  const sellerStatTotalWorth = document.getElementById(
    "seller-stat-total-worth"
  );

  const weeklyInsightsList = document.getElementById("weekly-insights-list");

  function renderSellerProfile() {
    const isSellerProfilePage = document.querySelector(
    ...
    if (!currentSellerData) {
      ...
      currentSellerData =
        sellerDetailedProfiles[Object.keys(sellerDetailedProfiles)[0]];
      if (!currentSellerData) {
        isSellerProfilePage.innerHTML =
          '<p style="text-align: center; color: #777; font-size: 1.2em; padding: 50px;">Seller profile not found.</p>';
        return;
      }
      showAlert(
        "Seller profile not found for the given ID. Displaying a default profile.",
        "info"
      );
    }
    ...
    if (sellerCompanyName)
      sellerCompanyName.textContent = currentSellerData.companyName;
    if (sellerOwnerName)
      sellerOwnerName.textContent = currentSellerData.ownerName;
    ...
    if (sellerTagline)
      sellerTagline.textContent = `"${currentSellerData.tagline}"`;
    if (sellerAvatar) sellerAvatar.src = currentSellerData.avatar;

    // Populate addresses
    const reachablePlacesInfo = document.querySelector(
      ".reachable-places-info ul"
    );
    ...
    // Populate stats
    if (sellerStatProducts)
      sellerStatProducts.textContent = currentSellerData.stats.products;
    if (sellerStatShipping)
      sellerStatShipping.textContent = currentSellerData.stats.shipping;
    if (sellerStatDelivery)
      sellerStatDelivery.textContent = currentSellerData.stats.delivery;
    if (sellerStatCancelled)
      sellerStatCancelled.textContent = currentSellerData.stats.cancelled;
    if (sellerStatRating)
      sellerStatRating.textContent = currentSellerData.stats.rating;
    if (sellerStatTotalWorth)
      sellerStatTotalWorth.textContent = currentSellerData.stats.totalWorth;
    ...
    if (weeklyInsightsList) {
      ...
      currentSellerData.weeklyInsights.forEach((insight) => {
        const li = document.createElement("li");
        li.innerHTML = `
                    <span class="dot ${insight.dotColor}"></span> ${
          insight.label
        }: ${insight.value}
                    ${
                      insight.icon
                        ? `<span class="material-icons small-star">${insight.icon}</span>`
                        : ""
                    }
                `;
